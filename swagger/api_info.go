...
type MarketResponse struct {
	MARKET_NAME      string `json:"name"`
	MARKET_PUBLICKEY string `json:"mkey"`
	MARKET_DESCR     string `json:"descr"`
	MARKET_IMG       string `json:"img"`
	MARKET_WORKTIME  string `json:"worktime"`
	MARKET_FEE       string `json:"fee"`
