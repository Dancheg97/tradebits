...
/*
# Распределение
Распределение будет производится каждый час в соотношении 90/10. 90% достается маркетам, в то время как 10% достается всем текущим держателям сети в соотношении эквивалентном к балансу их владельцев.
*/
